...
私は「汚い」コードを書けと言っているのでしょうか？
いいえ、「きれいな」とか「汚い」というのはどういう意味なのか、深く考えてみてください。
嫌な感情を感じますか？正義感？美しさ？優雅さ？
それぞれに対応する具体的なエンジニアリングの結果を挙げることができますか？
それらがコードの書き方や修正方法にどのような影響を与えるのか把握していますか？

私はこれらのことについて深く考えたことはありません。
コードがどのように見えるかについてはよく考えていましたが、人間のチームでどのように進化したかについては考えていませんでした。

コーディングは旅です。
最初のコードを書いてから今の場所にたどり着くまでの道のりを考えてみてください。
関数を抽出したり、クラスをリファクタリングしたりすることで、複雑なコードがいかにシンプルになるかを初めて知ることができたのは、とても嬉しいことだったと思います。
もしあなたが自分の技術に誇りを感じているなら、コードのクリーンさを追求したくなるでしょう。
しばらくはそれをやってみてください。

しかし、それだけで終わらせてはいけません。
クリーンコードの狂信者になってはいけません。
クリーンなコードはゴールではありません。
